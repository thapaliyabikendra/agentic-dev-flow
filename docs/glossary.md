...
*(no project-specific terms yet — add via glossary-curator Operation 1.)*
...
| 2.0 | 2026-04-28 | refactor | Relocated from plugin's `shared/` to project's `docs/`; "Platform Baseline" entry renamed to "Cross-Cutting Concerns" (cite updated to `docs/cross-cutting-concerns.md`); ownership shifted to `agent:glossary-curator` |
| 2.1 | 2026-04-28 | refactor | Removed banking-specific terms (Effective Date, Letter of Credit, Pending Revision, UCP 600); restructured Project Glossary into Baseline Terms / Project-Specific Terms subsections; aligned with plugin-shipped glossary template v1.0. |
